(function() {
    var project_data = {};
    project_data["token"] = "2816d23665565e6aeb13678e16a03a12";
    ...
    project_data["hosts"] = {
        api: {
            main: 'http:\/\/api-maps.yandex.ru\/',
            ua: 'http:\/\/legal.yandex.ru\/maps_termsofuse\/?lang={{lang}}',
            maps: 'http:\/\/maps.yandex.ru\/',
            services: {
                coverage: 'http:\/\/api-maps.yandex.ru\/services\/coverage\/',
                geoxml: 'http:\/\/api-maps.yandex.ru\/services\/geoxml\/',
                trafficInfo: 'http:\/\/api-maps.yandex.ru\/services\/traffic-info\/',
                route: 'https:\/\/api-maps.yandex.ru\/services\/route\/',
                regions: 'http:\/\/api-maps.yandex.ru\/services\/regions\/',
                geocode: 'http:\/\/geocode-maps.yandex.ru\/',
                psearch: 'http:\/\/psearch-maps.yandex.ru\/',
                suggest: 'http:\/\/suggest-maps.yandex.ru\/'
            }
        },
        layers: {
            map: 'http:\/\/vec0%d.maps.yandex.net\/tiles?l=map&%c&%l',
            sat: 'http:\/\/sat0%d.maps.yandex.net\/tiles?l=sat&%c&%l',
            skl: 'http:\/\/vec0%d.maps.yandex.net\/tiles?l=skl&%c&%l',
            pmap: 'http:\/\/0%d.pvec.maps.yandex.net\/?l=pmap&%c&%l',
            pskl: 'http:\/\/0%d.pvec.maps.yandex.net\/?l=pskl&%c&%l'
        },
        traffic: 'http:\/\/jgo.maps.yandex.net\/',
        trafficArchive: 'http:\/\/jft.maps.yandex.net\/'
    };
    project_data["layers"] = {
        'map': {
            version: '4.19.4',
    ...
    function init(e, t, n, r, i, s, o, u) {
        (function() {
            function l() {
                ...
                return r.loader = {
                    loadLimit: Math.floor((2e3 - a.length) / 2)
            ...
            function w() {
                ...
                var i = document.readyState == "complete",
                    s = f.vow.defer(),
                    o = 0;
                if(!i) {
                    function a() {
                ...
                var t, n = {
                    ...
                    r = function() {
                        var a = {
                            ...
                            m = function(t, n, r) {
                                typeof t == "string" && (t = [t]), p || (p = !0, h(w)), d.push({
                                    deps: t,
                                    cb: function(t, s) {
                                        s ? (r || i)(s) : n.apply(e, t)
                                    }
                            ...
                            S = function(e, t, r, i) {
                                ...
                                while(h < p) {
                                    ...
                                    if(typeof d == "string") {
                                        ...
                                        v = f[d].decl
                                    } else v = d; if(v.state === n.IN_RESOLVING && a.trackCircularDependencies && c(v, r)) {
                                        i(null, o(v, r));
                                        return
                                    }
                            ...
                            x = function(t, r, i) {
                                ...
                                var s = !1,
                                    o = t.prev ? t.deps.concat([t.prev]) : t.deps;
                    ...
                    h = function() {
                        ...
                        if("onreadystatechange" in a.createElement("script")) {
                            var f = a.getElementsByTagName("head")[0],
                                l = function() {
            ...
            var h = f.exports;
            h.setOptions({
                trackCircularDependencies: c.DEBUG,
            ...
            h.define("system.moduleLoader", ["system.moduleAliases", "system.nextTick", "system.project"], function(e, t, n, r) {
                    ...
                    function w() {
                        var e = r.data.loader.loadLimit,
                            t = Math.min(e, o.length),
                            i = 0,
                            u = [];
                        if(t) {
                            for(i = 0; i < t; i++) {
                    ...
                    function o(e, n, r) {
                        this._x = e, this._y = n, this._z = r, this._A = [], this._B = p({}, t), p(this._B, {
                            warning: function() {
                    ...
                    o.prototype.define = function(e, t, n) {
                        ...
                        var e = {},
                            t = n.isPackage(this._x),
                            r = t ? "" : this._x;
                        this._A.sort(s);
                        for(var i = 0, o = this._A.length; i < o; ++i) {
                            var u = this._A[i],
                                a = r ? u[0].split(r).join("") : u[0];
                    ...
                    var i = function(e, t, n) {
                            ...
                            for(var s = 0, o = t.length; s < o; ++s) {
                                var u = n[s].__package;
                                if(!u) m(e, t[s], n[s]), i[t[s]] || (r.push([t[s], n[s]]), i[t[s]] = 1);
                                else
                                    for(var a = 0; a < u.length; ++a) i[u[a][0]] || (m(e, u[a][0], u[a][1]), r.push([u[a][0], u[a][1]]), i[u[a][0]] = 1)
                            }
                    ...
                    e([
                        ...
                        ["b-cluster-carousel_pager_marker", "0S",
                            function(e) {
                                return [this.name + (e.support.browser.name == "MSIE" && e.support.browser.documentMode == 8 ? ".ie8" : e.support.browser.name == "MSIE" && e.support.browser.documentMode < 8 ? ".ie7" : ".standards")]
                            }
                        ],
                        ...
                        ["b-cluster-carousel_pager_numeric", "0W",
                            function(e) {
                                return [this.name + (e.support.browser.name == "MSIE" && e.support.browser.documentMode == 8 ? ".ie8" : e.support.browser.name == "MSIE" && e.support.browser.documentMode < 8 ? ".ie7" : ".standards")]
                            }
                        ],
                        ...
                        ["behavior.CurrentMultiTouchEngine", "0Q",
                            function(e) {
                        ...
                        ["graphics.render.detect.bestMatch", "6X",
                            function(e) {
                        ...
                        ["localization.common.current", "8D",
                            function(e) {
                        ...
                        ["theme.browser.webkit", "..",
                            function(e) {
                                var t = e.support.browser,
                                    n = t.isMobile || t.isTablet;
                        ...
                        ["theme.islands.cluster.metaOptions", "!u",
                            function(e) {
                        ...
                        ["theme.islands.geoObject.meta.standard", "!q",
                            function(e) {
                                var t = e.support.browser.oldIE;
                    ...
                    r.prototype = {
                        ...
                        _O: function(e, t, r, i, s) {
                            ...
                            this.isRejected() || (o = {
                                ...
                                fn: c(t) ? t : u,
                                ctx: s
                            }, this.isFulfilled() ? this._Q([o], this._J) : this._L.push(o)), this.isFulfilled() || (o = {
                                defer: e,
                                fn: r,
                                ctx: s
                            }, this.isRejected() ? this._Q([o], this._J) : this._M.push(o)), this._K === n.PENDING && this._N.push({
                                defer: e,
                                fn: i,
                                ctx: s
                            })
    ...
    init('ymaps', 'http://api-maps.yandex.ru/2.1.11/release/', false, {
        "name": "Chrome",
        "version": "36.0.1985",
        "engine": "WebKit",
        ...
        "isMobile": false,
        "cssPrefix": "Webkit"
    }, 'package.full', project_data, 'ymaps2_1_11', '')
})()